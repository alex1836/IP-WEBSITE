...
export function ContactPage() {
    ...
    return (
        <>
            <Helmet>
                <title>Contact DeIPTV Support | 24/7 Customer Service & Live Chat</title>
                <meta name="description" content="Need help with DeIPTV? Contact our 24/7 support team via live chat, email, or WhatsApp. We are here to assist you with installation, billing, and technical issues." />
                <meta name="keywords" content="contact deiptv, iptv support, iptv customer service, deiptv email, iptv live chat, iptv whatsapp support" />
                <link rel="canonical" href="https://deiptv8k.com/contact" />
            </Helmet>
