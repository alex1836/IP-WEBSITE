                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div className="space-y-8">
                        <h2 className="text-2xl sm:text-4xl font-bold leading-tight text-white">
                            3-Device Family <span className="text-cyan-400">DeIPTV Plan</span> – Annual Subscription for Just <span className="text-cyan-400">$157.99/year</span>
                        </h2>

                        <p className="text-lg text-gray-400 leading-relaxed">
                            Enjoy DeIPTV on up to 3 devices at once — perfect for families! Watch
                        ...
                        <div className="space-y-6">
                            <div className="space-y-2">
                                <div className="flex items-center gap-3 text-white font-semibold text-xl">
                                    ...
                                    Something for Everyone with DeIPTV
                                </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-gray-400 pl-9">
                                    Stream DeIPTV on Smart TVs, Firestick, tablets, or phones — all supported by IPTV
                    ...
                    <div className="relative perspective-1000 group">
                        ...
                        <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-700 transform rotate-y-6 transition-all duration-500 ease-out preserve-3d group-hover:rotate-y-0 group-hover:scale-[1.02]">
                            <img
                                src="/leads-iptv.webp"
                                alt="Family watching DeIPTV on TV"
