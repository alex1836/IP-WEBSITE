...
const benefits = [
    {
        ...
        description: 'Earn up to 100% profit on every DeIPTV subscription you sell.',
    },
    {
        icon: Users,
        title: 'Complete Control',
        description: 'Manage your customers and subscriptions through our easy-to-use DeIPTV reseller panel.',
    },
    {
        icon: Globe,
...
export function ResellerPage() {
    return (
        <>
            <Helmet>
                <title>Best IPTV Reseller Panel 2026 | Start Your IPTV Business with DeIPTV</title>
                <meta name="description" content="Join the DeIPTV Reseller Program and start your own IPTV business. Get the best IPTV reseller panel with high profit margins, 24/7 support, and instant activation." />
                <meta name="keywords" content="iptv reseller, best iptv reseller panel, sell iptv, iptv business, deiptv reseller, iptv panel, cheap iptv reseller" />
                <link rel="canonical" href="https://deiptv8k.com/reseller" />
            </Helmet>
            <div className="pt-24 pb-20 px-4 sm:px-6 lg:px-8 min-h-screen bg-gray-900">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <h1 className="text-4xl sm:text-5xl font-bold mb-4">
                            Become a <span className="text-cyan-400">DeIPTV Reseller</span>
                        </h1>
                        <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                            Start your own profitable IPTV business today with our premium reseller program
                        </p>
                    </div>
