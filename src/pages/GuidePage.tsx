...
export function GuidePage() {
    ...
    return (
        <>
            <Helmet>
                <title>How to Install IPTV on Firestick, Smart TV & Android | DeIPTV Setup Guide</title>
                <meta name="description" content="Step-by-step guide to install IPTV on Firestick, Samsung/LG Smart TV, Android, iOS and PC. Easy setup instructions for IPTV Smarters Pro and more." />
                <meta name="keywords" content="how to install iptv, iptv setup guide, iptv smarters pro setup, install iptv on firestick, samsung tv iptv setup, lg tv iptv, android iptv setup" />
                <link rel="canonical" href="https://deiptv8k.com/guide" />
            </Helmet>
            <div className="pt-24 pb-20 px-4 sm:px-6 lg:px-8 min-h-screen bg-gray-900">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <h1 className="text-4xl sm:text-5xl font-bold mb-4">
                            How to Install <span className="text-cyan-400">IPTV</span>
                        </h1>
